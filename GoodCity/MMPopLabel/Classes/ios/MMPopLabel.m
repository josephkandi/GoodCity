...
CGFloat const kMMPopLabelSidePadding = 16.0f;
CGFloat const kMMPopLabelViewPadding = 80.0f;
CGFloat const kMMPopLabelCornerRadius = 6.0f;
CGFloat const kMMPopLabelTipPadding = 8.0f;
CGFloat const labelLeftRightInset = 16.0f;
CGFloat const labelTopBottomInset = 2.0f;
...
- (void)setupAppearance
{
    ...
    CGRect rect = [attributedText boundingRectWithSize:(CGSize){maxWidth, CGFLOAT_MAX}
                                               ...
                                               context:nil];
    CGFloat minWidth = MAX(rect.size.width, 160);
    ...
    self.frame = CGRectMake(_targetFrame.origin.x,
                            ...
                            minWidth + labelLeftRightInset * 2,
                            _targetFrame.size.height + _tipSize * 4 + labelTopBottomInset * 2);
...
- (void)popAtView:(UIView *)view
{
    ...
    if (self.frame.origin.y + self.frame.size.height + kMMPopLabelViewPadding > [UIScreen mainScreen].applicationFrame.size.height)  {
